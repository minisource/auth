...
// NotifierHealth godoc
// @Summary Notifier service health info
// @Description Check live health status of the Notifier microservice
// @Tags Admin/Tools
// @Produce json
// @Security BearerAuth
// @Success 200 {object} response.Response
// @Router /admin/tools/notifier-health [get]
func (h *AdminToolsHandler) NotifierHealth(c *fiber.Ctx) error {
	notifierURL := os.Getenv("NOTIFIER_HTTP_URL")
	if notifierURL == "" {
		notifierURL = "http://localhost:9002"
	}
	healthURL := notifierURL + "/api/health"
