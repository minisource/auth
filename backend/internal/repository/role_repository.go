...
type RoleRepository interface {
	...
	ListByTenant(ctx context.Context, tenantID *uuid.UUID) ([]models.Role, error)
...
func (r *roleRepository) ListByTenant(ctx context.Context, tenantID *uuid.UUID) ([]models.Role, error) {
