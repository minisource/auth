...
type ServiceClientRepository interface {
	...
	ListByTenant(ctx context.Context, tenantID *uuid.UUID) ([]models.ServiceClient, error)
...
func (r *serviceClientRepository) List(ctx context.Context) ([]models.ServiceClient, error) {
	return r.ListByTenant(ctx, nil)
}

func (r *serviceClientRepository) ListByTenant(ctx context.Context, tenantID *uuid.UUID) ([]models.ServiceClient, error) {
