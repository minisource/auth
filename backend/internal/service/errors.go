...
const (
	...
	ErrCodeTwoFactorInvalid    = "two_factor_invalid"
	ErrCodeTwoFactorNotSetup   = "two_factor_not_setup"
	ErrCodePasskeyNotFound     = "passkey_not_found"
	ErrCodePasskeyExists       = "passkey_exists"
	ErrCodeNoPasskeys          = "no_passkeys"
	ErrCodeWebAuthnFailed      = "webauthn_failed"
	ErrCodeWebAuthnChallenge   = "webauthn_challenge_invalid"
)
...
var (
	...
	ErrInvalidTwoFactorCode  = errors.New("two-factor authentication code is invalid")
	...
	ErrNoPasskeys            = errors.New("no passkeys registered for this account")
	ErrWebAuthnFailed        = errors.New("WebAuthn operation failed")
	ErrWebAuthnChallenge     = errors.New("WebAuthn challenge is invalid or expired")
)
...
func NewTwoFactorInvalidError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodeTwoFactorInvalid, "Two-factor authentication code is invalid", "")
}

func NewTwoFactorNotSetupError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodeTwoFactorNotSetup, "Two-factor authentication is not set up", "")
}

func NewPasskeyNotFoundError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodePasskeyNotFound, "Passkey not found", "")
}

func NewPasskeyExistsError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodePasskeyExists, "This passkey is already registered", "")
}

func NewNoPasskeysError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodeNoPasskeys, "No passkeys registered for this account", "")
}

func NewWebAuthnFailedError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodeWebAuthnFailed, "WebAuthn operation failed", "")
}

func NewWebAuthnChallengeError() *service_errors.ServiceError {
	return service_errors.NewServiceError(ErrCodeWebAuthnChallenge, "WebAuthn challenge is invalid or expired", "")
}
