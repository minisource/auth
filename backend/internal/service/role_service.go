...
// ListRoles returns all roles (optionally filtered by tenant)
func (s *RoleService) ListRoles(ctx context.Context) ([]models.Role, error) {
	return s.roleRepo.ListByTenant(ctx, nil)
}

func (s *RoleService) ListRolesByTenant(ctx context.Context, tenantID *uuid.UUID) ([]models.Role, error) {
