...
// ListServiceClients returns all service clients (optionally filtered by tenant)
func (s *ServiceAuthService) ListServiceClients(ctx context.Context) ([]models.ServiceClient, error) {
	return s.serviceClientRepo.ListByTenant(ctx, nil)
}

func (s *ServiceAuthService) ListServiceClientsByTenant(ctx context.Context, tenantID *uuid.UUID) ([]models.ServiceClient, error) {
	return s.serviceClientRepo.ListByTenant(ctx, tenantID)
}
