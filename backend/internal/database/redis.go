...
// WebAuthnKey returns the Redis key for a WebAuthn challenge session.
func WebAuthnKey(challenge string) string {
	return fmt.Sprintf("%s%s", RedisKeyWebAuthn, challenge)
}
